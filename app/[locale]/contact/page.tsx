...
export default function ContactPage() {
  ...
  const contactGroups: { icon: string; label: string; items: ContactItem[] }[] = [
    {
      icon: '📞', label: 'Phone',
      items: [
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                  <div>
                    ...
                    <iframe src="https://www.google.com/maps?q=31.634016,-8.054315&z=15&output=embed" width="100%" height="220" style={{ border: 0, borderRadius: '12px' }} loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Marrakech Office Location" />
                  </div>
                  <div>
                    <div className="text-xs font-semibold uppercase tracking-wide text-gray-400 mb-2">Casablanca Office</div>
                    <iframe src="https://www.google.com/maps?q=33.572108,-7.553564&z=15&output=embed" width="100%" height="220" style={{ border: 0, borderRadius: '12px' }} loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Casablanca Office Location" />
                  </div>
                </div>
              </div>
            </div>
