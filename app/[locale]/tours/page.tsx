...
interface Tour {
  id: string;
  slug: string; // Added to interface for safe typing
  title: string;
  titleFr?: string;
  category: string;
  duration: string;
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
          ...
          <div className="flex gap-2">
            ...
            {/* Corrected: tour.slug is now targeted instead of tour.id */}
            <Link href={`/${locale}/tours/${tour.slug}`} className="btn-gold !py-2 !px-4 text-sm">
              View →
            </Link>
          </div>
        </div>
