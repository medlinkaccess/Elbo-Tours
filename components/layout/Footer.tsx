        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4 mt-5">
              ...
              <a href="https://web.facebook.com/profile.php?id=61591918824325" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-gray-600 flex items-center justify-center hover:border-[#C8960C] hover:text-[#C8960C] transition-colors text-gray-400">
              ...
              <a href="https://www.instagram.com/elbo_tours2026/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-gray-600 flex items-center justify-center hover:border-[#C8960C] hover:text-[#C8960C] transition-colors text-gray-400">
              ...
              <a href="https://www.youtube.com/channel/UCTeTlxxRzYHahE-D6TzPOlg" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-gray-600 flex items-center justify-center hover:border-[#C8960C] hover:text-[#C8960C] transition-colors text-gray-400">
